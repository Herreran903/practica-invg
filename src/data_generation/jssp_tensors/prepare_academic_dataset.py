"""
Academic dataset preparation for JSSP Tensors.
...
def prepare_academic_dataset(config: JSPPTensorsConfig) -> str:
    """
    ...
    print("=" * 75)
    print("ACADEMIC DATASET PREPARATION (JSPLIB Benchmarks) - TENSORS")
    print("=" * 75)
