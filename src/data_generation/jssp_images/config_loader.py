"""
Configuration loader for JSSP Images data generation.
...
class JSPPImagesConfig:
    """
    Configuration container for JSSP Images data generation.
    ...
    def _find_project_root(self) -> str:
        ...
        # Fallback: assume we're in src/data_generation/jssp_images/ -> go up to repo root
...
def load_config(config_path: str = "src/data_generation/jssp_images/config.yaml") -> JSPPImagesConfig:
    """
    Load configuration from YAML file.
    ...
    Returns:
        JSPPImagesConfig object with all settings loaded
    """
    return JSPPImagesConfig(config_path)