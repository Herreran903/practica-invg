...
Examples:
  ...
  python -m src.training.sat_images.cli --csv data.csv --task multilabel --time_limit 1800
    ...
    parser.add_argument("--task", type=str, required=True, choices=["classification", "multilabel", "regression"])
    parser.add_argument("--config", type=str, default="src/training/sat_images/config.yaml")
    parser.add_argument("--use_score", action="store_true")
    parser.add_argument("--epochs", type=int)
    parser.add_argument("--batch_size", type=int)
    parser.add_argument("--folds", type=int)
    parser.add_argument("--repeats", type=int, help="K-Fold repetitions (e.g., 5 for 5x5)")
    parser.add_argument("--learning_rate", type=float)
    parser.add_argument("--time_limit", type=float, help="Time limit in seconds (default: 1800)")
    parser.add_argument("--feat_time_col", type=str, help="Feature extraction time column")
    parser.add_argument("--solvers", type=str, help="Comma-separated solver names to use")
